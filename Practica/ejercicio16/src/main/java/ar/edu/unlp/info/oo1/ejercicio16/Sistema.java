...
public class Sistema {
	...
	public Propiedad registrarPropiedad(String nombre, String descripcion, double precio, String direccion, Politica politica) {
		Propiedad propiedad = new Propiedad(nombre,descripcion,precio,direccion, politica);
	...
	public double calcularDevolucion(Reserva reserva, LocalDate fechaCancelacion) {
		return reserva.calcularDevolucion(fechaCancelacion);
	}
}

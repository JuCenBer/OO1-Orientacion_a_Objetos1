...
public class TestSistema {
	...
	public void setUp() {
		...
		propiedad1 = sistema.registrarPropiedad("La casa de las brujas", "Una casa", 100, "Calle 11 420");
		propiedad2 = sistema.registrarPropiedad("Casa del arroyo", "En un arroyo", 50, "Calle 48 852");
